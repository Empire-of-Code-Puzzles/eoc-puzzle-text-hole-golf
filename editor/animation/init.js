...
requirejs(['ext_editor_1', 'jquery_190', 'raphael_210', 'snap.svg_030'],
    function (ext, $, Raphael, Snap) {
        ...
        ext.set_animate_slide(function (this_e, data, options) {
            ...
            var table = new PageTable($content.find(".explanation table"));
            table.draw(checkioInput);
...
//        });
        ...
        function PageTable($table) {
            ...
            this.showHoles = function(holes) {
                for (var i = 0; i < holes.length; i++) {
                    $table.find("tr").eq(holes[i][0]).find("td").eq(holes[i][1]).addClass("hole");
                }
            }
        }
